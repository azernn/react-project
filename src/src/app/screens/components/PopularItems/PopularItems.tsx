                ...
                <div className="cards">
                    <div className="c1">
                        <div className="image-title">
                            <div className="image"><img src="Frame 40.png" style="width: 284px;"/></div>
                            <div className="title">
                    ...
                    <div className="c1">
                        <div className="image-title">
                            <div className="image"><img src="Frame 40 (1).png " style="width: 284px;"/></div>
                            <div className="title">
                                <div className="Name-Location-Price">
                                    <div className="Name-Locatin">
                    ...
                    <div className="c1">
                        <div className="image-title">
                            <div className="image"><img src="Frame 40 (2).png" style="width: 284px;"/></div>
                            <div className="title">
                                <div className="Name-Location-Price">
                                    <div className="Name-Locatin">
                    ...
                    <div className="c1">
                        <div className="image-title">
                            <div className="image"><img src="Frame 40 (3).png" style="width: 284px;"/></div>
                            <div className="title">
                                <div className="Name-Location-Price">
                                    <div className="Name-Locatin">
                    ...
                    <div className="c1">
                        <div className="image-title">
                            <div className="image"><img src="Frame 40 (5).png" style="width: 284px;"/></div>
                            <div className="title">
                                <div className="Name-Location-Price">
                                    <div className="Name-Locatin">
